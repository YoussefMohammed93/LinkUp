  ...
  return (
    <>
      <main className="w-full min-w-0 space-y-5 my-5">
        <section>
          <header className="w-full bg-card border rounded-lg">
          ...
          <section className="rounded-lg border p-4 sm:p-6 my-5 bg-secondary/50 mx-5">
      ...
      {hasActiveStory && (
        <StoryViewer
          ...
          onOpenChange={setProfileStoryViewerOpen}
